...
class DetectorConstruction : public G4VUserDetectorConstruction
{
  ...
  public:
    ...
    void SetCylinderThickness (G4double);
    void SetCylinderMaterial (G4String);
  ...
  public:
    ...
    G4double           GetCylinderThickness()  {return fCylinderThickness;};
     G4Material*        GetCylinderMaterial()   {return fCylinderMaterial;};
  ...
  private:
     ...
     G4double           fCylinderThickness;
     G4Material*        fCylinderMaterial;
     G4LogicalVolume*   fLCylinder;
